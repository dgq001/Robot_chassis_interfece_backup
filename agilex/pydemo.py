...
class WSClient:
    ...
    def light_control(self):
        msg = {
            ...
            "msg": {
                ...
                "front_mode": 1,           #    1--常开  0--常关  2--呼吸灯  3--自由定义
                "front_custom_value": 0,    #    只有front_mode = 3 时有效
                "rear_mode": 1,
                "rear_custom_value": 0
            }
        }
    ...
    def location(self):
        ...
        r = self.send_msg(msg)
        print(r['msg']['pose']['pose']['position'])
    ...
    def heart_beat(self):
        ...
        if self.isconnect == True:
            ...
            return res
            time1 = Timer(10, self.heart_beat)
            time1.start()
    ...
    def record_bag(self, idtype, filename=''):
        return self.call_input(op_type='record_data', id_type=idtype, file_name=filename)
